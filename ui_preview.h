...
**
** Created: Sat Nov 9 15:56:40 2013
...
public:
    ...
    void setupUi(QMainWindow *Preview)
    {
        ...
        mainwidget = new QWidget(Preview);
        ...
        previewwidget = new QWidget(mainwidget);
        previewwidget->setObjectName(QString::fromUtf8("previewwidget"));
        previewwidget->setGeometry(QRect(0, 0, 321, 241));
        previewwidget->setMinimumSize(QSize(120, 80));
        Preview->setCentralWidget(mainwidget);
